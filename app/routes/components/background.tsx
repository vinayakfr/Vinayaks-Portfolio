export default function Background() {
  return (
    <div className="absolute h-40 w-40 md:h-56 md:w-56 lg:h-unit-8xl lg:w-unit-8xl 2xl:h-[43rem] 2xl:w-[43rem] border-2 rounded-none bg-rose-600 border-rose-600 opacity-80 animate-appearance-in">
      {/* Main Square */}
