  ...
  return (
    <div>
      ...
      <div className="text-white flex flex-col place-content-center place-items-center py-5">
        <h1 className="text-5xl xl:text-8xl font-bold bg-gradient-to-br from-zinc-800 via-rose-700 to-zinc-800 text-transparent bg-clip-text">Let's get in touch</h1>
