    ...
    <div>
      ...
      <div className='flex flex-row place-content-center place-items-center gap-4 xl:gap-14 px-4'>
          ...
          <div className='lg:w-[40rem] 2xl:w-[57.5rem] text-white text-sm xl:text-2xl 2xl:text-4xl flex flex-col gap-12 2xl:gap-20'>
            ...
            <p className='text-start'>Started spending more time on guitar during COVID.</p>
            <p className='text-end'>Received "Merit" in Electric Guitar Grade 3 from Trinity</p>
            <p className='text-start'>Participated in multiple guitar competitions and performed at multiple occasions.</p>
          </div>
          ...
          <div className='lg:w-[40rem] 2xl:w-[57.5rem] text-white text-sm xl:text-2xl 2xl:text-4xl flex flex-col gap-12 2xl:gap-20'>
            <p className="text-start pt-6">Learnt keyboard and was part of school choir</p>
            <p className='text-end'>
            ...
            <p className='text-start'>Got "Distinction" in Guitar Grade 2 Exam from Trinity</p>
            <p className='text-end'>Changed music school and started learning electric guitar.</p>
            <p>Became the member of Orchestra in new school </p>
            <p className='text-end'>Was crowned as "The best guitarist the school has ever seen"</p>
          </div>
      </div>
    </div>
  );
