  ...
  return (
    <div>
      <div className="flex gap-12">
        <div className="h-[22.5rem] w-72 md:w-[25rem] md:h-[20rem] xl:h-[20rem] xl:w-[40rem] bg-zinc-800 rounded-2xl grid grid-rows-3 place-content-center place-items-center px-3">
